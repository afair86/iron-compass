...
This is the same kind of grounding you can use in [Strength & Health](/domains/health) when stress shows up in the body. The point is to make the feeling present without letting it run the room.
...
This is where [Strength & Health](/domains/health) and simple movement can help.
