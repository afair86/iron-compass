...
{JSON.stringify({
	...
	"@type": "HowTo",
	"name": "Minimalist Strength for Busy Operators: 12-Week Capability Plan",
	"description": "Run a three-day Push/Pull/Legs program with simple progression and recovery floors to build dependable strength in 12 weeks.",
	"totalTime": "P12W",
	"step": [
		{"@type": "HowToStep", "name": "Choose three weekly sessions", "text": "Schedule Push, Pull, and Legs sessions 3x/week at 45–55 minutes each."},
		{"@type": "HowToStep", "name": "Run minimalist warm-up", "text": "Use 4–6 breathing, dynamic mobility, and 2–3 ramp sets before each main lift."},
		{"@type": "HowToStep", "name": "Progress simply", "text": "Hit rep tops, then add small load, then improve density; deload every 4th week."},
		{"@type": "HowToStep", "name": "Hold recovery floors", "text": "Maintain sleep, protein, hydration, and 10-minute mobility minimums weekly."},
		{"@type": "HowToStep", "name": "Adjust by readiness", "text": "Use Survive weeks when stressed: one top set + two back-off sets on mains, drop accessories."}
	]
})}
</script>
