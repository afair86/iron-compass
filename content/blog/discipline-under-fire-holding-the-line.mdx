...
{JSON.stringify({
	...
	"@type": "HowTo",
	"name": "Discipline Under Fire: Three-Level Day Protocol",
	"description": "Run Survive, Standard, and Surge day scripts with anchors and if-then rules to keep discipline alive under stress.",
	"step": [
		{"@type": "HowToStep", "name": "Choose day level", "text": "Pick Survive, Standard, or Surge based on sleep and energy; Survive is the floor during chaos."},
		{"@type": "HowToStep", "name": "Run anchor stack", "text": "Hydrate 20–30 oz on wake, get light + movement 5–10 minutes, write 3-call/3-task plan, state your day level."},
		{"@type": "HowToStep", "name": "Execute blocks", "text": "Standard: 1 Deep block (60–90m), 1 Build block (30–60m), Sweep block (30–45m). Surge adds a second Deep block."},
		{"@type": "HowToStep", "name": "Hold recovery floors", "text": "Protect sleep window, protein and steps minimums, and a nightly downshift routine."},
		{"@type": "HowToStep", "name": "Use if-then scripts", "text": "Prewrite responses for travel, sickness, stacked meetings, or family emergencies; default to Survive rules when in doubt."}
	]
})}
</script>
