...
const domains = [
  ...
  return (
    <main className="flex flex-col items-center px-4">
      {/* HERO + SIX DOMAINS SECTION (per hard spec) */}
      <section id="hero" className="max-w-5xl mx-auto px-4 pt-16 pb-16 lg:pt-24 lg:pb-24">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] items-start">
          {/* LEFT: Text content */}
          <div>
            <p className="heading-font text-xs text-icRed mb-3 tracking-[0.3em]">
              A SYSTEM FOR MEN
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              <a
                href="/domains"
                className="inline-flex items-center rounded-full bg-icRed px-6 py-2 text-sm font-semibold text-white shadow-lg shadow-icRedDark/40 hover:bg-icRedHover transition"
              >
                Start Your Rise
              </a>
              <a
            ...
            <p className="text-base text-icMuted">
          ...
          <aside className="ic-card rounded-2xl p-6 sm:p-7 lg:p-8 bg-icCard border border-slate-700/70 shadow-lg">
            <h2 className="heading-font text-sm text-icRed mb-2">
              THE SIX DOMAINS
            </h2>
            ...
            <div className="space-y-4 text-sm">
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="heading-font text-[11px] text-icText">
                    STRENGTH
                  </span>
                  <span className="text-[10px] text-icRed opacity-0 group-hover:opacity-100 transition">
                    Learn more →
                  </span>
                </div>
                <p className="text-xs text-icMuted">
                  Build physical and mental resilience to conquer life’s challenges.
                </p>
              </a>
              <a
                href="/domains/discipline"
              ...
              >
                ...
                <p className="text-xs text-icMuted">
                  Forge habits, self-control, and a winning mindset for lasting success.
                </p>
              </a>
              <a
                href="/domains/purpose"
              ...
              >
                ...
                <p className="text-xs text-icMuted">
                  Discover your mission and chart a course toward a meaningful life.
                </p>
              </a>
              <a
                href="/domains/leadership"
              ...
              >
                ...
                <p className="text-xs text-icMuted">
                  Lead with integrity, inspire others, and become a man of value.
                </p>
              </a>
              <a
                href="/domains/finance"
              ...
              >
                ...
                <p className="text-xs text-icMuted">
                  Achieve financial stability and growth through smart decisions.
                </p>
              </a>
              <a
                href="/domains/ai"
              ...
              >
                ...
                <p className="text-xs text-icMuted">
                  Leverage AI and systems to optimize every aspect of your life.
                </p>
              </a>
            </div>
          </aside>
