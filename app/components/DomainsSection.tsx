...
import { domainCards as domainCardData } from "@/lib/domains";

const domainIcons: Record<string, Domain["icon"]> = {
  health: (
...
export const domainCards: Domain[] = domainCardData.map((card) => ({
  title: card.title,
  desc: card.desc,
  href: card.href,
